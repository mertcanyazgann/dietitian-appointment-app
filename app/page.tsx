  ...
  return (
    <main className="min-h-screen bg-[#f7f7f2] text-slate-900">
      <header className="glass-header sticky top-0 z-50 border-b border-black/5">
        <div className="container-site flex items-center justify-between py-4">
          ...
          <nav className="hidden items-center gap-7 text-sm text-slate-600 lg:flex">
            <a href="#hakkimda" className="animated-underline transition hover:text-slate-900">
              Hakkımda
            </a>
            <a href="#hizmetler" className="animated-underline transition hover:text-slate-900">
              Hizmetler
            </a>
            <a href="#surec" className="animated-underline transition hover:text-slate-900">
              Süreç
            </a>
            <a href="#iletisim" className="animated-underline transition hover:text-slate-900">
              İletişim
            </a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex rounded-full border border-slate-300 bg-white p-3 text-slate-700 lg:hidden"
            >
        ...
        {mobileMenuOpen && (
          <div className="container-site border-t border-black/5 pb-4 pt-3 lg:hidden">
            <div className="flex flex-col gap-3 rounded-3xl bg-white p-4 shadow-sm">
              <a href="#hakkimda" onClick={() => setMobileMenuOpen(false)}>Hakkımda</a>
      ...
      <section className="hero-grid">
        <div className="container-site grid gap-8 pb-14 pt-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:pb-20 lg:pt-16">
          <div className="section-reveal">
            <div className="floating-badge inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white px-4 py-2 text-sm text-emerald-700 shadow-sm">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {stats.map((item) => (
                <div key={item.label} className="soft-card lift rounded-3xl p-5">
      ...
      <section id="hakkimda" className="container-site section-reveal py-10 lg:py-16">
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[32px] bg-[#e8f5ee] p-8 lg:p-10">
            ...
            <p className="mt-5 leading-8 text-slate-600">
              Danışanların yaşam düzenini, hedeflerini ve sürdürülebilirlik ihtiyacını merkeze alarak ilerliyorum.
              Amaç; kısa süreli motivasyon değil, uzun vadeli ve uygulanabilir alışkanlıklar oluşturmaktır.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item.title} className="soft-card lift rounded-[28px] p-6">
      ...
      <section id="hizmetler" className="container-site section-reveal py-10 lg:py-16">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {services.map((item) => (
            <div key={item.title} className="soft-card lift group rounded-[30px] p-7">
      ...
      <section id="surec" className="section-reveal bg-white">
        <div className="container-site py-10 lg:py-16">
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-3">
            {steps.map((item) => (
              <div key={item.no} className="lift rounded-[30px] border border-black/5 bg-[#fafaf7] p-7 shadow-sm">
      ...
      <section id="iletisim" className="container-site section-reveal py-10 lg:py-16">
        <div className="grid gap-5 lg:grid-cols-3">
          {[
            ...
            <div key={item.title} className="soft-card lift rounded-[28px] p-7">
